...
from .segmentation import sigmoid_focal_loss, dice_loss, interpolate

from .rtdetrv2_criterion import RTDETRCriterionv2


@register()
class MaskRTDETRCriterion(RTDETRCriterionv2):
    ...
    def __init__(self, \
        ...
        """
        super().__init__(matcher, weight_dict, losses, alpha, gamma, num_classes, boxes_weight_format, share_matched_indices)
